...
export function generateCard({
  ...
  const autoStyle   = stylePRNG.int(0, 7);
  const symbolStyle = (logoStyle >= 0 && logoStyle <= 7) ? logoStyle : autoStyle;
  ...
  if (showArtifacts) drawArtifacts(ctx, geometry, isDark, artifactPRNG);
